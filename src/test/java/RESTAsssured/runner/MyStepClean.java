package RESTAsssured.runner;

import RESTAsssured.factoryRequest.FactoryRequest;
import RESTAsssured.factoryRequest.RequestInformation;
import RESTAsssured.helpers.Configuration;
import RESTAsssured.helpers.JsonAssert;
...
public class MyStepClean {
    ...
    public void elAtributoFullNameDeberiaSerLucianoPaniaguaUpdate(String atributo,String expected) {
        response.then()
